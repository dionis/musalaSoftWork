...
export class DevicesService implements Resolve<any>
{
    ...
    getContacts(): Promise<any>
    {
        return new Promise((resolve, reject) => {
                ...
                console.log("Route to Show ==> " + this.createCompleteRoute('/device/find-all-device', this._envUrl.urlAddress))
                this._httpClient.get(this.createCompleteRoute('device/find-all-device', this._envUrl.urlAddress))
                    .subscribe((response: any) => {

                        this.contacts = response.result;
                        let message = response.mssg;
                        
                       // console.log("RESPONSE  BEFORE " + JSON.stringify(  this.contacts))
